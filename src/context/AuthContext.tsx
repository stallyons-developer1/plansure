...
// Static credentials
const USERS = [
  { email: 'admin@plansure.com', password: 'password', role: 'admin' as UserRole },
  { email: 'user@plansure.com', password: 'password', role: 'user' as UserRole },
  { email: 'planner@plansure.com', password: 'password', role: 'planner' as UserRole },
];
