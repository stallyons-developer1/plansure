          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <Box>
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 0.5, fontSize: "12px" }}>
                <Typography component="span" sx={{ color: COLORS.green, fontSize: "12px", fontWeight: 400 }}>24 on track</Typography>
                <Typography component="span" sx={{ color: COLORS.textSecondary, fontSize: "12px" }}>·</Typography>
                <Typography component="span" sx={{ color: COLORS.amber, fontSize: "12px", fontWeight: 400 }}>18 at risk</Typography>
                <Typography component="span" sx={{ color: COLORS.textSecondary, fontSize: "12px" }}>·</Typography>
                <Typography component="span" sx={{ color: COLORS.red, fontSize: "12px", fontWeight: 400 }}>8 critical</Typography>
              </Box>
            </Box>
        ...
        <Card sx={{ bgcolor: COLORS.bgSecondary, border: `1px solid ${COLORS.border}`, borderRadius: 3, p: 2.5 }}>
          <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <Box>
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 0.5, fontSize: "12px" }}>
                <Typography component="span" sx={{ color: COLORS.red, fontSize: "12px", fontWeight: 400 }}>4 overdue</Typography>
                <Typography component="span" sx={{ color: COLORS.textSecondary, fontSize: "12px" }}>·</Typography>
                <Typography component="span" sx={{ color: COLORS.textSecondary, fontSize: "12px", fontWeight: 400 }}>8 pending</Typography>
              </Box>
            </Box>
